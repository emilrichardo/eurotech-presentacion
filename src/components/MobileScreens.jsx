    ...
    <section id="mobile" className="relative py-28">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-start mb-20">
          ...
          <div className="flex-1 space-y-5 pt-4">
            <h3 className="text-white font-bold text-xl">Diseño Mobile-First</h3>
            <p className="text-dark-300 text-sm leading-relaxed">
              La experiencia móvil fue diseñada desde cero teniendo en cuenta que la mayoría de los usuarios
              acceden desde sus celulares. Cada pantalla fue optimizada para interacción táctil.
            </p>
            <div className="space-y-3">
              {[
                { label: 'Navegación táctil', desc: 'Targets de touch ≥ 44px, swipe en carousels' },
                { label: 'Header compacto', desc: 'Logo + búsqueda + carrito en la misma línea' },
                { label: 'Menú lateral', desc: 'Panel deslizable con categorías completas' },
                { label: 'Cards de producto', desc: 'Grid de 2 columnas, información prioritizada' },
                { label: 'Checkout simplificado', desc: 'Formularios de una columna, teclados nativos' },
                { label: 'Bottom sheet', desc: 'Filtros y opciones emergentes desde abajo' },
              ].map(({ label, desc }) => (
                <div key={label} className="flex items-start gap-3 p-3 bg-dark-800/50 rounded-lg border border-dark-700">
      ...
      <div className="relative">
        <div className="px-6 mb-4 flex items-center justify-between max-w-6xl mx-auto">
          <h3 className="text-dark-200 text-sm font-medium">Todas las pantallas</h3>
            ...
            return (
              ...
              >
                ...
                <div className="text-center">
                  <div className="text-dark-300 text-xs font-medium">{label}</div>
                  <div className="text-dark-600 text-xs font-mono">{String(i + 1).padStart(2, '0')}</div>
                </div>
              </div>
            )
          })}
